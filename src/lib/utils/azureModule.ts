...
// export const getSubnetInfo = async () => {
//   console.log("\nGetting subnet info for: " + subnetName);
//   const getResult = await networkClient.subnets.get(resourceGroupName, vnetName, subnetName);
//   return getResult;
// }
...
// export const createNIC = (async subnetInfo =>, publicIPInfo) {
...
//   console.log(
//     util.format(
//       "\nFinding a VM Image for location %s from " + "publisher %s with offer %s and sku %s",
//       location,
//       publisher,
//       offer,
//       sku
